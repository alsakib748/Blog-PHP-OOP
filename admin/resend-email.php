                ...
                <div class="col-md-5 my-5">
                    ...
                    <div class="card shadow border-0 ">
                        <div class="card-header bg-secondary">
                            <h5 class="text-light fs-4">Resend Email Form</h5>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <input type="submit" class="btn btn-primary shadow-none" value="Resend Email" name="resend">
                                
                                <a href="login.php" class="btn btn-warning shadow-none">Login</a>
